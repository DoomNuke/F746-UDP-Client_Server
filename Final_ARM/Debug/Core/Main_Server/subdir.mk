...
C_SRCS += \
../Core/Main_Server/Main_Server.c 

OBJS += \
./Core/Main_Server/Main_Server.o 

C_DEPS += \
./Core/Main_Server/Main_Server.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Main_Server/%.o Core/Main_Server/%.su Core/Main_Server/%.cyclo: ../Core/Main_Server/%.c Core/Main_Server/subdir.mk
...
clean: clean-Core-2f-Main_Server

clean-Core-2f-Main_Server:
	-$(RM) ./Core/Main_Server/Main_Server.cyclo ./Core/Main_Server/Main_Server.d ./Core/Main_Server/Main_Server.o ./Core/Main_Server/Main_Server.su

.PHONY: clean-Core-2f-Main_Server
