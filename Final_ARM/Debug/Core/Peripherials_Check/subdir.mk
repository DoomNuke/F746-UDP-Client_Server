...
C_SRCS += \
../Core/Peripherials_Check/Peripherials_Check.c 

OBJS += \
./Core/Peripherials_Check/Peripherials_Check.o 

C_DEPS += \
./Core/Peripherials_Check/Peripherials_Check.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Peripherials_Check/%.o Core/Peripherials_Check/%.su Core/Peripherials_Check/%.cyclo: ../Core/Peripherials_Check/%.c Core/Peripherials_Check/subdir.mk
...
clean: clean-Core-2f-Peripherials_Check

clean-Core-2f-Peripherials_Check:
	-$(RM) ./Core/Peripherials_Check/Peripherials_Check.cyclo ./Core/Peripherials_Check/Peripherials_Check.d ./Core/Peripherials_Check/Peripherials_Check.o ./Core/Peripherials_Check/Peripherials_Check.su

.PHONY: clean-Core-2f-Peripherials_Check
